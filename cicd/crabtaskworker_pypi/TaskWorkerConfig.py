...
############################################################################
config.TaskWorker.name = 'crab-dev-tw03' #Remember to update this!
...
config.TaskWorker.recurringActions = ['RemovetmpDir', 'BanDestinationSites', 'TapeRecallManager', 'GetAcceleratorSite']
...
config.TaskWorker.restURInoAPI = '/crabserver/other/'

config.TaskWorker.restHost = 'cmsweb-test12.cern.ch'
config.TaskWorker.dbInstance = 'devthree'
